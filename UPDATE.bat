@echo off
title LOTRO Death Tracker - Update auf v2.4
...
echo ================================================================
echo.
echo         LOTRO DEATH TRACKER - UPDATE AUF VERSION 2.4
echo.
echo ================================================================
echo.
...
echo MsgBox "LOTRO Death Tracker v2.4 aktualisiert! Watcher laeuft im Hintergrund. Windows-Neustart ist NICHT noetig.", 64, "Update fertig!" > "%TEMP%\_lotro_update_done.vbs"
